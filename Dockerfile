...
RUN apt update && \
    ...
    curl --retry 5 --retry-max-time 120 -L -o maven-dependency-submission-linux-x64 https://github.com/advanced-security/maven-dependency-submission-action/releases/download/v4.1.1/maven-dependency-submission-action-linux && \
